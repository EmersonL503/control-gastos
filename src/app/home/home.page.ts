...
export class HomePage implements OnInit {
  ...
  this.dataService.getGastos().subscribe(res=> {
      ...
      this.gastosMayores = res.sort((a, b) => parseFloat(b.cantidad) - parseFloat(a.cantidad));
      this.gastosMayores = this.gastosMayores.slice(0, 3);

    console.log(this.gastosMayores);
  ...
  this.ingresosService.getIngresos().subscribe(res=> {
      ...
      this.ingresosMayores = res.sort((a, b) => parseFloat(b.cantidad) - parseFloat(a.cantidad));
      this.ingresosMayores = this.ingresosMayores.slice(0, 3);

      console.log(this.ingresosMayores);
